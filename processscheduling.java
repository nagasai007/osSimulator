...
public class processscheduling{
	float average=0;
	static JFrame f;
	processscheduling(program[] p,int counter){
		if(counter==0)
		{
			f=new JFrame();  
		    f.setTitle("Inputs");
		...
		//  f.setLayout(null);  
		    ...
		    average/=10;
		    data[10][0]="Average Waiting Time";
		    data[10][1]=Float.toString(average);
		    JTable table=new JTable(data,column);  
		    table.setBounds(30,40,200,300);  
		    table.setBounds(30,40,200,300);  
		    table.setBounds(30,40,200,300);  
		...
		static class program{
			...
			public int setArrivalTime(int x){
				arrivalTime=(int)(x+Math.random()*5);
				//Crespoters code
				return arrivalTime;
			}
			public void print(){
			...
			EventQueue.invokeLater(new Runnable() {
				public void run() {
					try {
						...
						processscheduling.f.setVisible(true);
					} catch (Exception e) {
						e.printStackTrace();
					}
				}
		...
		public void initialize(){
			...
			for(int i=0;i<10;i++)
			{
			 ...
			 new processscheduling(programs,0); 
			...
			new processscheduling(programs,1);
			//ROUND ROBIN
			...
			new processscheduling(programs,2);
			...
			new processscheduling(programs,3);
		...
		new processscheduling(programs,4);
		...
		new processscheduling(programs,5);
		...
		new processscheduling(programs,6);
